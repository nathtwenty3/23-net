...
<head>
    ...
    {{-- <link href="{{ asset('backend/assets/images')}}" rel="stylesheet" type="text/css" /> --}}
                ...
                <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">                        
                    ...
                    <li class="mx-3 welcome-text">
                        {{-- <h3 class="mb-0 fw-bold text-truncate"> 
                            Good Morning,<a class="text-truncate" aria-haspopup="true" aria-expanded="false" v-pre>{{ Auth::user()->name }}</a>
                        </h3> --}}
