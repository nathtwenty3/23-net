                            ...
                            <div class="card">
                                <div class="card-body p-0 auth-header-box rounded-top">
                                    <div class="text-center p-3">
                                        ...
                                        <h4 class="mt-3 mb-1 fw-semibold text-primary fs-18">Create an account</h4>   
                                ...
                                <div class="card-body pt-0">                                    
                                    <form class="my-4" method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group mb-2">
                                            <label class="form-label" for="password-confirm">ConfirmPassword</label>                                            
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid mt-3">
                                                    <button class="btn btn-primary" type="submit">
                                                        {{ __('Register') }}<i class="fas fa-sign-in-alt ms-1"></i>
                                                    </button>
                                                </div>
                                            </div><!--end col--> 
                                        </div> <!--end form-group-->                           
